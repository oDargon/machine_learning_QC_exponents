...
work_dir       = BASE_DIR / "F_ground_test_prop"
...
cma_culling( exp, start_energy_g, O_GCA, work_dir, 5, generation_size=24, max_generations=300, threads=12, overwrite=True, logging=2, optimize_initial=True, propagate_covariance=True )